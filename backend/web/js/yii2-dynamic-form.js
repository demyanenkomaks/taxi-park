...
(function ($) {
    ...
    var _addItem = function(widgetOptions, e, $elem) {
        ...
        if (count < widgetOptions.limit) {
            ...
            $toclone.find('.kv-plugin-loading').hide();
    ...
    var _restoreSpecialJs = function(widgetOptions) {
        ...
        if ($hasDateTimepicker.length > 0) {
            $hasDateTimepicker.each(function() {
                $(this).parent().removeData().datetimepicker({"format":"dd.mm.yyyy H:i", 'language':'ru'});
                $(this).parent().datetimepicker({"format":"dd.mm.yyyy H:i", 'language':'ru'});
            });
        }
        ...
        if ($hasDatepicker.length > 0) {
            $hasDatepicker.each(function() {
                $(this).parent().removeData().kvDatepicker({'language':'ru'});
                $(this).parent().kvDatepicker({'language':'ru'});
            });
        }
